package com.projectDB.Shop.db.service.api.request;
...
public class UpdateProductRequest {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.price, price) == 0 && available == that.available && Objects.equals(name, that.name) && Objects.equals(description, that.description);
    }
